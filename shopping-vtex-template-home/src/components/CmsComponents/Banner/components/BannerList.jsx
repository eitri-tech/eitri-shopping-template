...
export default function BannerList(props) {
	...
	return (
		// Esse 'isHideBanner' é a prop que condiciona a renderização do banner ou não, configurável pelo cms caso tenham o 'sections.json' atualizado
		<View className={`flex flex-col gap-2 ${data?.isHideBanner ? 'hidden' : 'block'}`}>
			...
			<View className='flex overflow-x-auto gap-4 px-4'>
				{imagesList &&
